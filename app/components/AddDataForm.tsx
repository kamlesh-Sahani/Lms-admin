...
const AddDataForm = ({
  ...
  return (
    <div className=" flex justify-center  mt-10">
      <form
        className={`flex flex-col gap-6 bg-white shadow-md p-10  ${
            ...
            <Fragment key={i}>
              {int[0] == "button" ? (
                <div className="flex flex-col gap-2 " key={i}>
                  <input
                    type={int[1]}
                    className="h-[50px] w-[400px] rounded pl-2 shadow hover:bg-[#0c6cd9a9]  outline-0 cursor-pointer bg-[#0c6DD9] text-white font-bold"
                  />
                </div>
              ) : (
